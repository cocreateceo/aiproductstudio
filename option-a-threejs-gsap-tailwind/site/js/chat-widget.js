...
class ChatWidget {
            ...
            if (saved) {
                ...
                if (parsed.timestamp && Date.now() - parsed.timestamp < 24 * 60 * 60 * 1000) {
                    ...
                    return {
                        ...
                        duplicateChecked: parsed.duplicateChecked || false,
                        duplicateCheckedEmail: parsed.duplicateCheckedEmail || null
                    };
                }
            }
        } catch (e) {
                ...
                <div class="chat-header">
                    <div class="chat-header-info">
                        ...
                        <div>
                            ...
                            <p class="chat-session-info">
                                Your session will be active for 24 hours
                                <span class="info-tooltip" data-tooltip="After 24 hours, your session will expire. To continue your previous conversation, simply provide your name and email when you return, and we'll restore your chat history.">
    ...
    addMessage(role, content, isWelcome = false) {
        ...
        if (role !== 'system') {
            ...
            // Add to filtered messages (for display)
            this.state.messages.push(message);
            // Add to all messages (for storage)
